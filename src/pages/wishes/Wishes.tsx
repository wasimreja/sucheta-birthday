...
const sampleMessagesDataArray: TMessagesData[] = [
  ...
  },
  {
    ...
    messageInParas: [
      ...
      "We just click, you know? From deep talks to laughing at the dank memes, you get me in a way no one else does. You're there for me through thick and thin, always down to listen. You've seen me at my most goofy and still stuck around. Thanks for being my ride-or-die and the best friend anyone could ask for.",
